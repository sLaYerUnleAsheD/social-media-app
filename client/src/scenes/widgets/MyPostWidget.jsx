...
const MyPostWidget = ({ picturePath }) => {
    ...
    // below state represents a switch if the user has opened the
    // image dropping area to upload an image for the post
    const [isImage, setIsImage] = useState(false);
    // actual image if user drops an image in upload
    const [image, setImage] = useState(null);
    // represents actual content of description of post
    ...
    const handlePost = async () => {
        // using formData because I will be dealing with an image
        ...
        // backend returns list of updated posts
